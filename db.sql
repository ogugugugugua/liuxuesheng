...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='留学生信息表';
...
CREATE TABLE traveler(
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uniq_account_name (account_name)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT = '旅客 ';