...
public class Trip implements Serializable {
    ...
    public Trip(String uuid, String creatorUuid, String title, String description,
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getRankTop() == null ? other.getRankTop() == null : this.getRankTop().equals(other.getRankTop()))
            && (this.getStatus() == null ? other.getStatus() == null : this.getStatus().equals(other.getStatus()))
            && (this.getPrivateTrip() == null ? other.getPrivateTrip() == null : this.getPrivateTrip().equals(other.getPrivateTrip()))
