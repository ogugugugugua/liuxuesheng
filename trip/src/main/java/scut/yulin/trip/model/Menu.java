...
public class Menu implements Serializable {
    ...
    public Menu(String uuid, String restaurantUuid, String name, String description,
        BigDecimal price) {
        this.uuid = uuid;
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getRestaurantUuid() == null ? other.getRestaurantUuid() == null : this.getRestaurantUuid().equals(other.getRestaurantUuid()))
