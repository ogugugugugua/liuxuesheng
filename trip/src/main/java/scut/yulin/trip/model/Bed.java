...
public class Bed implements Serializable {
    ...
    public Bed(String uuid, Integer numberPerson, String type, String roomUuid,
        Integer quantity) {
        this.uuid = uuid;
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getNumberPerson() == null ? other.getNumberPerson() == null : this.getNumberPerson().equals(other.getNumberPerson()))
