...
import scut.yulin.trip.mbg.mapper.CountryCodeDao;
...
public class CountryCodeServiceImpl implements CountryCodeService {
  ...
  private static final String json = "[{\"cn\":\"阿富汗\",\"en\":\"Afghanistan\",\"phone_code\":\"+93\"},\n"
  ...
  private void addCountryCode() {
    ...
    for (int i = 0; i < maps.size(); i++) {
      CountryCode countryCode = new CountryCode(IdUtil.randomUUID(),
          (String) maps.get(i).get("cn"), (String) maps.get(i).get("en"),
          (String) maps.get(i).get("phone_code"));
      countryCodeDao.insertSelective(countryCode);
    }
  }

  @Override
  public List<CountryCode> getCountryCodeList() {
    CountryCodeExample example = new CountryCodeExample();
    example.setOrderByClause("cn");
    example.createCriteria().andUuidIsNotNull();
    return countryCodeDao.selectByExample(example);
  }
}
