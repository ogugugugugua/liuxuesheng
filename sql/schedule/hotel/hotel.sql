...
(
    ...
    check_in_time      VARCHAR(5)      NOT NULL DEFAULT '15:00' COMMENT '最早入住时间',
    check_out_time     VARCHAR(5)      NOT NULL DEFAULT '12:00' COMMENT '最晚离开时间',
    description        VARCHAR(1024)   NOT NULL DEFAULT '' COMMENT '酒店描述',
    type               VARCHAR(32)     NOT NULL DEFAULT '' COMMENT '酒店类型',
    built_year         CHAR(4)         NOT NULL DEFAULT '' COMMENT '建成年份',
    scale              INT             NOT NULL DEFAULT -1 COMMENT '酒店规模',
    cancel_policy      VARCHAR(64)     NOT NULL DEFAULT '可免费取消' COMMENT '预订取消政策',
    remark             VARCHAR(1024)   NOT NULL DEFAULT '' COMMENT '保留字段',
