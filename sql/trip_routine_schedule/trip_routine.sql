...
(
    ...
    classification VARCHAR(36)   NOT NULL DEFAULT '' COMMENT '旅途分类',
    ...
    private_trip    VARCHAR(1)    NOT NULL DEFAULT 0 COMMENT '是否私密行程 私密是1,公开是0',
    original       VARCHAR(1)    NOT NULL DEFAULT 1 COMMENT '是否原创 原创是1,非原创是0',
    created_time   DATETIME      NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    updated_time   DATETIME      NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
    deleted        VARCHAR(1)    NOT NULL DEFAULT 0 COMMENT '已删除 yes:1,no:0',
    PRIMARY KEY (id),
