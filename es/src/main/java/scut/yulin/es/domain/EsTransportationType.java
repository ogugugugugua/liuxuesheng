...
@Data
public class EsTransportationType implements Serializable {
  ...
  public EsTransportationType(String uuid, String type, String cnName, String creatorUuid) {
    this.uuid = uuid;
    this.type = type;
    this.cnName = cnName;
  ...
  public boolean equals(Object that) {
    ...
    EsTransportationType other = (EsTransportationType) that;
