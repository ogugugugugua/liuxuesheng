...
@Data
@NoArgsConstructor
public class EsEquipment implements Serializable {
  ...
  public EsEquipment(String uuid, String equipmentName, String parameter, String roomUuid,
      Integer quantity) {
    this.uuid = uuid;
  ...
  public boolean equals(Object that) {
    ...
    EsEquipment other = (EsEquipment) that;
    return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
        ...
        && (this.getEquipmentName() == null ? other.getEquipmentName() == null
        : this.getEquipmentName().equals(other.getEquipmentName()))
