...
@NoArgsConstructor
public class EsTransportation implements Serializable {
  ...
  private EsTransportationType esTransportationType;
  ...
  public EsTransportation(String uuid, String scheduleUuid, String scheduleTypeUuid,
  ...
  public EsTransportationType getEsTransportationType() {
    return esTransportationType;
  }

  public void setEsTransportationType(EsTransportationType esTransportationType) {
    this.esTransportationType = esTransportationType;
  }
  ...
  public boolean equals(Object that) {
    ...
    EsTransportation other = (EsTransportation) that;
