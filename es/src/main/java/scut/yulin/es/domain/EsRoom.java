...
@Data
@NoArgsConstructor
public class EsRoom implements Serializable {
  ...
  public EsRoom(String uuid, String type, String vipGrade, Integer numberPerson,
