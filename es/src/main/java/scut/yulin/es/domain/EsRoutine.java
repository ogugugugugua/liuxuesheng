 ...
 * @author
 */
@ApiModel(value = "scut.yulin.trip.model.Routine日安排")
@Data
@NoArgsConstructor
public class EsRoutine implements Serializable {

  /**
   * 非数据库字段 当天所有行程列表
   */
  @ApiModelProperty(value = "当天所有行程列表")
  List<EsResult_Routine_Schedule_DTO> scheduleList;
  ...
  public EsRoutine(String uuid, String supplement, Date curDate) {
    this.uuid = uuid;
  ...
  public boolean equals(Object that) {
    ...
    EsRoutine other = (EsRoutine) that;
    return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
        && (this.getUuid() == null ? other.getUuid() == null
        : this.getUuid().equals(other.getUuid()))
        && (this.getCurDate() == null ? other.getCurDate() == null
        : this.getCurDate().equals(other.getCurDate()))
